...
Item {
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            Text {
                text: "SYSTEM"
                font.family: "SF Pro Display"; font.weight: Font.Black
            ...
            component PmItem: Rectangle {
                ...
                RowLayout {
                    ...
                    Text { text: label; font.family: "SF Pro Display"; font.pixelSize: 14 * sc; font.weight: Font.Medium; color: pmItemMa.containsMouse ? accent : Qt.rgba(accent.r, accent.g, accent.b, 0.5); Behavior on color { ColorAnimation { duration: 150 } } }
                }
