...
Item {
    ...
    Timer { interval: 1000; running: true; repeat: true; onTriggered: modeReader.running = true }
    ...
    function connectDevice(mode, id, macOrSsid, password) {
        ...
        if (mode === "eth") {
            ...
            let ifaceCmd = window.activeWifiInterface !== "" ? (" ifname '" + window.activeWifiInterface + "'") : "";
            if (password !== "") {
                connectProcess.command = ["bash", "-c", "nmcli device wifi connect '" + macOrSsid + "' password '" + password + "'" + ifaceCmd];
            } else {
                connectProcess.command = ["bash", "-c", "nmcli device wifi connect '" + macOrSsid + "'" + ifaceCmd];
            }
        } else {
    ...
    property string activeWifiInterface: ""
    property bool hasMultipleWifi: wifiInterfaces.length > 1
    ...
    function processWifiJson(textData, isCache = false) {
        ...
        try {
            ...
            if (data.interfaces) window.wifiInterfaces = data.interfaces;
            if (data.active_interface) window.activeWifiInterface = data.active_interface;
            let fetchedPower = data.power || "off";
    ...
    Timer {
        interval: (Object.keys(window.busyTasks).length > 0 || Object.keys(window.disconnectingDevices).length > 0) ? 1000 : (window.visible ? 1000 : 8000)
    ...
    Timer {
        interval: 33
        running: window.visible && window.opacity > 0
        repeat: true
        onTriggered: {
            window.globalOrbitAngle = (window.globalOrbitAngle + (Math.PI * 2 / (200000 / 33))) % (Math.PI * 2)
        }
    }
    ...
    Item {
        ...
        Rectangle {
            anchors.fill: parent
            radius: window.s(20)
            color: Qt.rgba(window.base.r, window.base.g, window.base.b, 0.45)
            ...
            Rectangle {
                ...
                opacity: window.currentPower ? 0.04 : 0.01
            ...
            Rectangle {
                ...
                opacity: window.currentPower ? 0.03 : 0.01
            ...
            Item {
                ...
                opacity: (window.currentPower && window.activeMode !== "eth") ? 1.0 : 0.0
                ...
                Canvas {
                    ...
                    NumberAnimation on scanAngle {
                        ...
                        duration: 3000
                        loops: Animation.Infinite
                        running: radarItem.visible && window.currentPower && (window.activeMode === "wifi" || window.activeMode === "bt")
                    }
                    ...
                    onPaint: {
                        ...
                        var cx = width / 2;
                        var cy = height / 2;
                        var r = Math.min(width, height) / 2 - window.s(20);
                        
                        // Draw concentric rings
                        ctx.strokeStyle = "rgba(" + window.activeColor.r*255 + "," + window.activeColor.g*255 + "," + window.activeColor.b*255 + ", 0.25)";
                        ...
                        // Sweeping scan cone
                        if(radarItem.visible && window.currentPower && window.activeMode !== "eth") {
                            ctx.save();
                            ctx.translate(cx, cy);
                            ctx.rotate(scanAngle * Math.PI / 180);
                            
                            var gradient = ctx.createConicGradient(0, 0, 0);
                            gradient.addColorStop(0, "rgba(" + window.activeColor.r*255 + "," + window.activeColor.g*255 + "," + window.activeColor.b*255 + ", 0.0)");
                            gradient.addColorStop(0.1, "rgba(" + window.activeColor.r*255 + "," + window.activeColor.g*255 + "," + window.activeColor.b*255 + ", 0.6)");
                            gradient.addColorStop(1, "rgba(" + window.activeColor.r*255 + "," + window.activeColor.g*255 + "," + window.activeColor.b*255 + ", 0.0)");
                            
                            ctx.beginPath();
                            ctx.moveTo(0,0);
                            ctx.arc(0, 0, r, 0, 0.3 * Math.PI);
                            ctx.closePath();
                            ctx.fillStyle = gradient;
                            ctx.fill();
                            
                            // Radar sweep leading edge
                            ctx.beginPath();
                            ctx.moveTo(0,0);
                            ctx.lineTo(Math.cos(0.3*Math.PI)*r, Math.sin(0.3*Math.PI)*r);
                    ...
                    delegate: Item {
                        ...
                        Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                Text { Layout.alignment: Qt.AlignHCenter; font.family: "Inter"; font.weight: Font.Bold; font.pixelSize: window.s(14); color: window.overlay0; text: window.currentPowerPending ? (window.expectedEthPower === "on" ? "Powering On..." : "Powering Off...") : "Disconnected" }
                            }
                            ...
                            Item {
                                ...
                                ColumnLayout {
                                    ...
                                    Text { 
                                        ...
                                        font.family: "Inter"; font.weight: Font.Bold; font.pixelSize: window.s(13)
                            ...
                            Item {
                                ...
                                ColumnLayout {
                                    ...
                                    Text {
                                        Layout.alignment: Qt.AlignHCenter
                                        font.family: "Inter"; font.weight: Font.Bold; font.pixelSize: window.s(11)
                                        ...
                                        ColumnLayout {
                                            ...
                                            Item {
                                                ...
                                                Text {
                                                    ...
                                                    anchors.verticalCenter: parent.verticalCenter
                                                    text: floatCard.itemName
                                                    font.family: "Inter"; font.weight: Font.Bold; font.pixelSize: window.s(13); color: window.crust 
                                                }
                                                Text { 
                                            ...
                                            Text {
                                                font.family: "Inter"; font.pixelSize: window.s(10); color: window.crust
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        scale: ethTabMa.containsMouse ? 1.05 : 1.0
                        ...
                        RowLayout {
                            ...
                            Text { font.family: "Inter"; font.weight: Font.Black; font.pixelSize: window.s(13); color: window.activeMode === "eth" ? window.crust : window.text; text: "Ethernet"; Behavior on color { ColorAnimation{duration:200} } }
                        }
                        MouseArea {
                    ...
                    Rectangle {
                        ...
                        scale: wifiTabMa.containsMouse ? 1.05 : 1.0
                        Behavior on scale { NumberAnimation { duration: 250; easing.type: Easing.OutBack } }
                        Behavior on color { ColorAnimation { duration: 200 } }
                        ...
                        RowLayout {
                            ...
                            Text { font.family: "Inter"; font.weight: Font.Black; font.pixelSize: window.s(13); color: window.activeMode === "wifi" ? window.crust : window.text; text: "Wi-Fi"; Behavior on color { ColorAnimation{duration:200} } }
                        }
                        MouseArea {
                    ...
                    Rectangle {
                        ...
                        scale: btTabMa.containsMouse ? 1.05 : 1.0
                        Behavior on scale { NumberAnimation { duration: 250; easing.type: Easing.OutBack } }
                        Behavior on color { ColorAnimation { duration: 200 } }
                        ...
                        RowLayout {
                            ...
                            Text { font.family: "Inter"; font.weight: Font.Black; font.pixelSize: window.s(13); color: window.activeMode === "bt" ? window.crust : window.text; text: "Bluetooth"; Behavior on color { ColorAnimation{duration:200} } }
                        }
                        MouseArea {
            ...
            Item {
                ...
                visible: window.activeMode === "wifi" && window.hasMultipleWifi
                z: 200
                width: window.s(140)
                height: dropdownOpen ? window.s(32) + (window.wifiInterfaces.length * window.s(30)) + window.s(8) : window.s(32)
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text {
                                Layout.fillWidth: true
                                text: window.activeWifiInterface
                                font.family: "Inter"
                            ...
                            Text {
                                text: interfaceSelector.dropdownOpen ? "󰅀" : "󰅂"
                                font.family: "Iosevka Nerd Font"
                        ...
                        MouseArea {
                            ...
                            onClicked: interfaceSelector.dropdownOpen = !interfaceSelector.dropdownOpen
                        }
                    }
                    ...
                    ColumnLayout {
                        ...
                        Repeater {
                            model: window.wifiInterfaces
                            delegate: Rectangle {
                                Layout.fillWidth: true
                                Layout.preferredHeight: window.s(30)
                                color: ifaceMa.containsMouse ? window.surface1 : "transparent"
                                ...
                                Text {
                                    ...
                                    font.family: "Inter"
                                    font.pixelSize: window.s(12)
                                    color: window.activeWifiInterface === modelData ? window.text : window.subtext0
                                    elide: Text.ElideRight
                                }
                                MouseArea {
                                    id: ifaceMa
                                    ...
                                    cursorShape: Qt.PointingHandCursor
                                    onClicked: {
                                        interfaceSelector.dropdownOpen = false;
                                        if (window.activeWifiInterface !== modelData) {
                                            window.activeWifiInterface = modelData;
                                            window.playSfx("switch.wav");
                                            Quickshell.execDetached(["bash", "-c", "echo '" + modelData + "' > '" + window.cacheDir + "/wifi_iface'"]);
