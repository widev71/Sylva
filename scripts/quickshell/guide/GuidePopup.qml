...
Item {
    ...
    property var tabNames: ["Settings", "Profile", "System", "Modules", "Matugen", "About"]
    ...
    Item {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                opacity: 0.06
                layer.enabled: true
                layer.effect: MultiEffect { blurEnabled: true; blurMax: 30; blur: 1.0 }
            }
            ...
            Item {
                ...
                Flickable {
                    ...
                    Rectangle {
                        ...
                        radius: root.s(16)
                        color: profileBoxMa.containsMouse ? Qt.alpha(root.surface0, 0.7) : Qt.alpha(root.surface0, 0.4)
                        border.color: profileBoxMa.containsMouse ? root.ambientBlue : root.surface1
                        border.width: 1
                        clip: true
                        ...
                        Rectangle {
                            ...
                            color: root.ambientBlue
                            opacity: 0.15
                            x: profileBoxMa.containsMouse ? parent.width * 0.7 : parent.width * 0.8
                            y: -root.s(50)
                            layer.enabled: true
                        ...
                        Rectangle {
                            ...
                            color: root.ambientPurple
                            opacity: 0.15
                            x: profileBoxMa.containsMouse ? root.s(50) : -root.s(50)
                            y: root.s(20)
                            layer.enabled: true
                            layer.effect: MultiEffect { blurEnabled: true; blurMax: 20; blur: 1.0 }
                            Behavior on x { NumberAnimation { duration: 800; easing.type: Easing.OutExpo } }
                        ...
                        RowLayout {
                            ...
                            Item {
                                ...
                                Rectangle {
                                    ...
                                    radius: root.s(50)
                                    color: "transparent"
                                    border.color: Qt.alpha(root.ambientPurple, profileBoxMa.containsMouse ? 0.8 : 0.3)
                                    border.width: root.s(3)
                                    scale: profileBoxMa.containsMouse ? 1.05 : 1.0
                                ...
                                Item {
                                    ...
                                    MultiEffect { 
                                        source: userAvatarImgProfile
                                        anchors.fill: userAvatarImgProfile
                                        maskEnabled: true
                                        maskSource: avatarMaskProfile
                                    ...
                                    Rectangle {
                                        ...
                                        Text { 
                                            ...
                                            color: root.text
                                            visible: root.faceIconPath === ""
                                            scale: profileBoxMa.containsMouse ? 1.1 : 1.0
                        ...
                        MouseArea { id: profileBoxMa; anchors.fill: parent; hoverEnabled: true }
                    }
                    ...
                    Rectangle {
                        id: linksContainer
                        Layout.fillWidth: true
                        Layout.preferredHeight: linksCol.implicitHeight + root.s(30)
                        radius: root.s(16)
                        color: Qt.alpha(root.surface0, 0.4)
                        border.color: root.surface1
                        border.width: 1
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Repeater {
                                    model: [ 
                                        { name: Config.profileDiscord, icon: "󰙯", color: "blue", url: "https://discord.com/" }, 
                                        { name: Config.profileInstagram, icon: "", color: "pink", url: "https://instagram.com/" + Config.profileInstagram },
                                        { name: Config.profileTikTok, icon: "", color: "red", url: "https://tiktok.com/@" + Config.profileTikTok }
                                    ]
                                    ...
                                    Rectangle {
                                        ...
                                        Layout.preferredHeight: root.s(44)
                                        radius: root.s(10)
                                        color: socialBtnMa.containsMouse ? Qt.alpha(root[modelData.color], 0.15) : Qt.alpha(root.surface0, 0.6)
                                        border.color: socialBtnMa.containsMouse ? root[modelData.color] : Qt.alpha(root.surface1, 0.5)
                                        border.width: 1
                                        scale: socialBtnMa.pressed ? 0.95 : 1.0
                            ...
                            Rectangle {
                                ...
                                radius: root.s(10)
                                color: authorMa.containsMouse ? Qt.alpha(root.surface1, 0.6) : Qt.alpha(root.surface0, 0.6)
                                border.color: authorMa.containsMouse ? root.mauve : Qt.alpha(root.surface1, 0.5)
                                border.width: 1
                                ...
                                RowLayout {
                                    ...
                                    Row {
                                        ...
                                        Repeater {
                                            model: {
                                                let str = Config.profileGithub || "witya";
                                                let arr = [];
                                                let colors = [root.red, root.peach, root.yellow, root.green, root.sapphire, root.blue, root.mauve, root.pink];
                                                for (let i = 0; i < str.length; i++) {
                                                    arr.push({ l: str[i], c: colors[i % colors.length] });
                                                }
                                                return arr;
                                            }
                                            Text { 
                                ...
                                MouseArea { 
                                    ...
                                    hoverEnabled: true
                                    cursorShape: Qt.PointingHandCursor
                                    onClicked: Quickshell.execDetached(["xdg-open", "https://github.com/" + Config.profileGithub]) 
                                }
                            }
                        }
                    }
                    ...
                    Rectangle {
                        id: githubBox
                        Layout.fillWidth: true
                        Layout.preferredHeight: githubContent.implicitHeight + root.s(40)
                        radius: root.s(16)
                        color: githubBoxMa.containsMouse ? Qt.alpha(root.surface0, 0.7) : Qt.alpha(root.surface0, 0.4)
                        border.color: githubBoxMa.containsMouse ? root.ambientGreen : root.surface1
                        border.width: 1
                        clip: true
                        ...
                        Rectangle {
                            ...
                            height: root.s(300)
                            radius: root.s(150)
                            color: root.ambientGreen
                            opacity: 0.12
                            x: githubBoxMa.containsMouse ? parent.width * 0.6 : parent.width * 0.8
                            y: parent.height * 0.2
                            layer.enabled: true
                            layer.effect: MultiEffect { blurEnabled: true; blurMax: 20; blur: 1.0 }
                            Behavior on x { NumberAnimation { duration: 800; easing.type: Easing.OutExpo } }
                        ...
                        Rectangle {
                            ...
                            color: root.ambientBlue
                            opacity: 0.12
                            x: githubBoxMa.containsMouse ? root.s(30) : -root.s(50)
                            y: parent.height * 0.5
                            layer.enabled: true
                            layer.effect: MultiEffect { blurEnabled: true; blurMax: 20; blur: 1.0 }
                            Behavior on x { NumberAnimation { duration: 800; easing.type: Easing.OutExpo } }
                        ...
                        MouseArea { id: githubBoxMa; anchors.fill: parent; hoverEnabled: true }
                    ...
                    Item { Layout.preferredHeight: root.s(20) }
                }
                }
            }
