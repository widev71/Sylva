...
Item {
    ...
    property var tabNames: ["Umum", "Cuaca", "Pintasan", "Monitor", "Autostart", "Profil"]
    property var tabIcons: ["󰒓", "󰖐", "󰌌", "󰍹", "󰐥", "󰀉"]
    property var tabColors: ["teal", "blue", "peach", "green", "mauve", "pink"]
    ...
    property var allSettingsCards: [
        { tab: 0, boxIndex: 0, label: "Panduan saat mulai",   desc: "Tampil otomatis saat login",    icon: "󰑊", color: "peach" },
        { tab: 0, boxIndex: 1, label: "Ikon bantuan",         desc: "Tampilkan tombol di topbar",    icon: "󰋖", color: "blue" },
        { tab: 0, boxIndex: 2, label: "Skala UI",             desc: "Ukuran dasar tampilan",         icon: "󰁦", color: "sapphire" },
        { tab: 0, boxIndex: 3, label: "Layout keyboard",      desc: "Sesuai hyprland.conf",          icon: "󰌌", color: "green" },
        { tab: 0, boxIndex: 4, label: "Pintasan layout",      desc: "Kombinasi tombol ganti layout", icon: "󰯍", color: "teal" },
        { tab: 0, boxIndex: 5, label: "Folder wallpaper",     desc: "Path folder wallpaper",         icon: "󰋩", color: "mauve" },
        { tab: 0, boxIndex: 6, label: "Workspace",            desc: "Jumlah workspace di topbar",    icon: "󰽿", color: "red" },
        { tab: 1, boxIndex: 1, label: "API Key",              desc: "Kunci API OpenWeather",         icon: "󰌆", color: "blue" },
        { tab: 1, boxIndex: 2, label: "ID Kota",              desc: "ID kota di OpenWeather",        icon: "󰖐", color: "blue" },
        { tab: 1, boxIndex: 3, label: "Satuan Suhu",          desc: "Celsius / Fahrenheit / Kelvin", icon: "󰔄", color: "blue" }
    ]
    ...
    property var monResAccentColors: [root.pink, root.mauve, root.blue, root.teal, root.yellow, root.peach, root.green, root.red, root.sapphire, root.sky, root.mauve, root.flamingo]
