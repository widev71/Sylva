...
Item {
    ...
    property string activeEqPreset: "Vocal"
    ...
    NumberAnimation on globalOrbitAngle {
        from: 0; to: Math.PI * 2; duration: 90000; loops: Animation.Infinite; running: window.opacity > 0
    }
    ...
    Item {
        ...
        Rectangle {
            ...
            ColumnLayout {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    Row {
                                        ...
                                        spacing: window.s(3)
                                        height: window.s(24)
                                        visible: window.activeVol > 0 && !window.activeMute
                                        Repeater {
                                            model: 12
                                            Rectangle {
                                                width: window.s(4); radius: window.s(2); color: window.tabColor; anchors.bottom: parent.bottom
                                                height: window.s(4)
                                                SequentialAnimation on height {
                                                    loops: Animation.Infinite; running: window.activeVol > 0 && !window.activeMute
                                                    NumberAnimation { to: window.s(8) + (index % 4) * window.s(4); duration: 200 + (index % 3) * 50; easing.type: Easing.InOutQuad }
                                                    NumberAnimation { to: window.s(4); duration: 200 + (index % 2) * 50; easing.type: Easing.InOutQuad }
                                                    NumberAnimation { to: window.s(12) + ((index*2) % 5) * window.s(2); duration: 150 + (index % 3) * 50; easing.type: Easing.InOutQuad }
                                                }
                                            }
                                        }
                                    }
                    ...
                    RowLayout {
                        ...
                        Repeater {
                            ...
                            delegate: Item {
                                Layout.fillWidth: true
                                Layout.fillHeight: true
                                scale: tabMa.containsMouse ? 1.05 : 1.0
                ...
                // ==========================================
                // EQ PROFILES ROW (Glassmorphism Buttons)
                // ==========================================
                GridLayout {
                    columns: 4
                    Layout.fillWidth: true
                    ...
                    visible: window.activeTab === "outputs"
                    opacity: introHeader
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            // Track active state (fake for UI demo, real one uses easyeffects)
                            property bool isActivePreset: modelData === window.activeEqPreset
                            
                            color: isActivePreset ? window.tabColor : (tabMaEQ.containsMouse ? Qt.rgba(window.tabColor.r, window.tabColor.g, window.tabColor.b, 0.2) : Qt.rgba(window.surface0.r, window.surface0.g, window.surface0.b, 0.4))
                            border.color: isActivePreset || tabMaEQ.containsMouse ? window.tabColor : "transparent"
                            border.width: 1
                            ...
                            MouseArea {
                                ...
                                anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                                onClicked: {
                                    window.activeEqPreset = modelData;
                                    Quickshell.execDetached(["bash", "-c", "~/.config/hypr/scripts/quickshell/music/equalizer.sh preset '" + modelData + "'"]);
                                }
                            }
                        }
                    }
