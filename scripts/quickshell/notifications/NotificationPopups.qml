...
PanelWindow {
    ...
    Item {
        ...
        SequentialAnimation on glowPulse {
            ...
            NumberAnimation { from: 0.0; to: 1.0; duration: 2000; easing.type: Easing.InOutSine }
            NumberAnimation { from: 1.0; to: 0.0; duration: 2000; easing.type: Easing.InOutSine }
        }
                            ...
                            Repeater {
                                ...
                                delegate: Rectangle {
                                    ...
                                    color: {
                                        ...
                                        if (isPrimary) {
                                            return actionMouseArea.containsMouse ? Qt.alpha(_theme.blue, 0.8) : Qt.alpha(_theme.blue, 0.5)
                                        } else {
                                            return actionMouseArea.containsMouse ? Qt.alpha(_theme.surface2, 0.8) : Qt.alpha(_theme.surface1, 0.4)
                                        }
                                    }

                                    border.color: (!_theme.blue) ? "transparent" : (isPrimary ? _theme.blue : Qt.alpha(_theme.surface2, 0.6))
