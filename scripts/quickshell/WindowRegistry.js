...
function getLayout(name, mx, my, mw, mh, userScale) {
    ...
    let base = {
        ...
        "todo":      { w: s(400, scale), h: s(600, scale), rx: mw - s(404, scale), ry: s(60, scale), comp: "todo/TodoPopup.qml" },
        "notifications": { w: s(360, scale), h: s(760, scale), rx: mw - s(365, scale), ry: s(60, scale), comp: "notifications/NotificationPopup.qml" },
        
        // --- Central Standard Tools ---
        "applauncher": { w: mw, h: mh, rx: 0, ry: 0, comp: "applauncher/appLauncher.qml" },
        ...
        "calendar":  { w: s(1450, scale), h: s(480, scale), rx: Math.floor((mw/2)-(s(1450, scale)/2)), ry: s(60, scale), comp: "calendar/CalendarPopup.qml" },
	"updater": { w: s(950, scale), h: s(850, scale), rx: Math.floor((mw/2)-(s(950, scale)/2)), ry: Math.floor((mh/2)-(s(850, scale)/2)), comp: "updater/UpdaterPopup.qml" },
        "wallpaper": { w: mw, h: mh, rx: 0, ry: 0, comp: "wallpaper/WallpaperPicker.qml" },
